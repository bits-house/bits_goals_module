...
void main() {
  ...
  final tLogModel = ActionLogModel.fromEntity(
    ActionLog.create(
      ...
      userDeviceInfo: DeviceInfo('test-device'),
      userIpAddress: IpAddress('127.0.0.1'),
    ),
  );
  ...
  group('AnnualRevenueGoalFirestoreDataSource Implementation Tests', () {
    setUp(() {
      ...
      dataSource = AnnualRevenueGoalRemoteDataSourceFirestoreImpl(config);
    });
    ...
    group('Success Scenarios', () {
      test(
        ...
        () async {
          ...
          expect(
            logs.docs.first.data()[ActionLogRemoteSchemaV1.useCaseId],
            'setup_2026_goals',
          );
        },
      );
    ...
    group('Error Handling & Firebase Mapping', () {
      ...
      void setupErrorEnvironment(Object firebaseError) {
        ...
        dataSource = AnnualRevenueGoalRemoteDataSourceFirestoreImpl(mockConfig);
      }
